...
import { Start4 } from '@/components/event-organization/start4'
  ...
  return (
    <>
      ...
      >
        ...
        <path
          d='M977.76 159.05C1000.4 159.05 1018.76 140.694 1018.76 118.05C1018.76 95.4063 1000.4 77.05 977.76 77.05C955.116 77.05 936.76 95.4063 936.76 118.05C936.76 140.694 955.116 159.05 977.76 159.05Z'
          fill='#EDEDED'
          stroke='#F0002C'
          strokeWidth='2'
          strokeLinecap='round'
        ...
        <path
          d='M1031.56 118.05C982.12 120.46 980.17 122.41 977.76 171.85C975.35 122.41 973.4 120.46 923.96 118.05C973.4 115.64 975.35 113.69 977.76 64.25C980.17 113.69 982.12 115.64 1031.56 118.05Z'
          fill='#EDEDED'
          stroke='#F0002C'
          strokeWidth='2'
          strokeLinecap='round'
        ...
        <path
          d='M375.93 760.65C291.57 764.76 288.24 768.09 284.12 852.46C280.01 768.1 276.68 764.77 192.31 760.65C276.67 756.54 280 753.21 284.12 668.84C288.23 753.2 291.56 756.53 375.93 760.65Z'
          fill='#EDEDED'
          stroke='#F0002C'
          strokeWidth='2'
          strokeLinecap='round'
        ...
        <path
          d='M472.77 159.05C495.413 159.05 513.77 140.694 513.77 118.05C513.77 95.4063 495.413 77.05 472.77 77.05C450.126 77.05 431.77 95.4063 431.77 118.05C431.77 140.694 450.126 159.05 472.77 159.05Z'
          fill='#EDEDED'
          stroke='#F0002C'
          strokeWidth='2'
          strokeLinecap='round'
