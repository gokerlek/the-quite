...
export default function Home() {
  ...
  return (
    <Layout>
      <div ref={scrollRef} className='h-screen overflow-y-auto overflow-x-hidden touch-pan-y'>
        <div
          ref={containerRef}
        ...
        {showScrollIndicator && (
          <div className='text-offblack-100 fixed bottom-4 left-1/2 -translate-x-1/2 z-10 pointer-events-none'>
            Scroll
          </div>
        )}
      </div>
