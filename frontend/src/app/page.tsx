...
export default function Home() {
  ...
  return (
    <Layout>
      <div ref={containerRef} className='relative min-h-screen bg-offblack-950 overflow-hidden'>
        <svg
          id='quiet-drawing-logo'
          viewBox='0 0 860 654'
          fill='none'
          xmlns='http://www.w3.org/2000/svg'
          className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[20vw]'
          opacity={0}
        >
          <path
      ...
      {showScrollIndicator && (
        <div className='text-offblack-100 fixed bottom-4 left-1/2 -translate-x-1/2 z-10'>
          Scroll
        </div>
      )}
    </Layout>
