    ...
    <Layout>
      ...
      >
        <div className='text-2xl sm:text-5xl sm:max-w-1/2 font-light  text-left text-offblack-50 text-balance'>
          We are the curators of the moment. Seekers of the unforgettable. We are the quiet.
          It&apos;s a society, ıt&apos;s a journey.
        </div>

        <button className='bt-white px-5 py-2 bg-offblack-50 text-offblack-950 hover:opacity-80 transform hover:scale-95 transition-all duration-300 ease-in-out'>
          DISCOVER
        </button>
      </section>
      ...
      <section
        id='the_quite_white'
        className='absolute bottom-40 left-1/2 -translate-x-1/2 translate-y-1/2 z-20 opacity-0 pointer-events-none w-[min(80vw,640px)]'
      >
        <svg
          viewBox='0 0 480 240'
          fill='none'
          xmlns='http://www.w3.org/2000/svg'
          className='fill-offblack-50 w-full h-auto'
        >
          <path d='M72.5022 78V87.8667H72.1245L70.9689 84.2178C70.0889 81.4311 67.5022 79.5378 64.5822 79.5333H56C53.7022 79.5333 51.84 81.3956 51.84 83.6889V154.929C51.8622 157.68 53.6267 160.12 56.2356 161L58.2089 161.667V162.044H41.96V161.667L43.96 161C46.5911 160.12 48.3689 157.649 48.3689 154.871V83.6978C48.3689 81.4 46.5111 79.5378 44.2134 79.5378H35.4622C32.5378 79.5378 29.9556 81.4356 29.0756 84.2178L27.92 87.8667H27.5422V78H72.4934H72.5022Z' />
